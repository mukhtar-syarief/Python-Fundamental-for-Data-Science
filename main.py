...
biodata = {"nama":"Budi",'umur':20} #proses inisialisasi variabel biodata
print(biodata) #proses pencetakan variabel biodata yang berisi tipe data Dictionary
type(biodata) #fungsi untuk mengecek jenis tipe data. akan tampil <class 'disting'>
...
if(i==10): #pengecekan nilai i apakan sama dengan 10
    print("ini adalah angka 10") #jika TRUE maka akan mencetak kalimat ini
else:
...
#for (1)
for i in range (1,6): #perulangan for sebagai inisialisasi dari angka 1 hingga yang lebih kecil daripada 6.
